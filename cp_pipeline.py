"""Lightweight conformal prediction pipeline for recommendation outputs."""
...
def run_cp_once(
    ...
    if lambda_hat is None:
        raise ValueError(
            "No lambda_hat found that satisfies the FDP constraint on calibration. "
            "Try relaxing alpha/increasing delta, using a coarser lambda_step, or adjusting label_threshold."
        )
